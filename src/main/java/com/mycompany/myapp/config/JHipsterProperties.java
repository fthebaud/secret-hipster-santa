...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "secretSanta@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "secretSanta API";

        private String description = "secretSanta API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "secretSanta";
